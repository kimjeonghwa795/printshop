...
<?php $data = array(
              'name'        => 'ig_picpuller_lite_prefix',
              'id'          => 'ig_picpuller_lite_prefix',
              'value'       => '',
              'maxlength'   => '128',
              'size'        => '30',
              'style'       => 'width:98%',
            );
echo "<tr><td>".form_label('Prefix for returned Pic Puller tags ', 'ig_picpuller_lite_prefix')."</td><td>".form_input($data)."</tr>";
...
<p>Note: Your current <em>prefix</em> is set to: <em><strong><?=$ig_picpuller_lite_prefix;?></strong></em>. To keep this unchanged, <strong><a href="<?=$cancel_url;?>">CANCEL</a></strong> and return to the <em><?=$ig_info_name;?></em> menu.</p>
