						...
						<fieldset class="holder">
							<table cellspacing="0" cellpadding="0" border="0" width="100%" class="product_edit">
								...
								<tbody>
									...
									<tr>
										<td><?=lang('Sort Order')?></td>
                                           <td><?=form_input(array('name'=>'sort_order','type'=>'number','value'=>@$products[0]['sort_order'] ? $products[0]['sort_order'] : 1 ,'style' => 'width:100px' ))?></td>
									</tr>
								</tbody>
							</table>
						</fieldset>
