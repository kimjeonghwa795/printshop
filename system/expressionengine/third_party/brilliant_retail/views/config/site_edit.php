					...
					$catalog .= '	<tr>
							...
							<table cellpadding="0" cellspacing="0" class="mainTable padTable"  style="width:100%;">
								...
								<tbody>
									...
									<tr>
										<td valign="top" width="35%" style="padding-top:15px;">
											'.lang('br_downloads_s3_access_key').'</td>
										<td>
											'.form_input(
															'downloads_s3_access_key',
															$store['downloads_s3_access_key'] 
														).'</td>
									</tr>
									<tr>
										<td valign="top" width="35%" style="padding-top:15px;">
											'.lang('br_downloads_s3_secret_key').'</td>
										<td>
											'.form_input(
															'downloads_s3_secret_key',
															$store['downloads_s3_secret_key'] 
														).'</td>
									</tr>
									<tr>
										<td valign="top" width="35%" style="padding-top:15px;">
											'.lang('br_downloads_s3_length').'</td>
										<td>
											'.form_input(
															'downloads_s3_length',
															$store['downloads_s3_length'] 
														).'<br /><em>'.lang('br_downloads_s3_length_description').'</em></td>
									</tr>
								</tbody>
							</table>
						</div>';					
