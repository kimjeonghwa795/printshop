	...
	// Install the gateway
		public function install($config_id){
			...
			$data[] = array(
							...
							'code'		=> 'image_url', 
							'type' 		=> 'text',
							'descr' 	=> '(Optional) The URL of the 150x50-pixel image displayed as your logo in the upper left corner of the PayPal checkout pages. Default � Your business name',
							'sort' 		=> 4
							);
			$data[] = array(
							'config_id' => $config_id, 
							...
							'type' 		=> 'text',
							'descr' 	=> '(Optional) The image at the top left of the checkout page. The image�s maximum size is 750 pixels wide by 90 pixels high. PayPal recommends that you provide an image that is stored only on a secure (https) server.',
							'sort' 		=> 5
							);
