...
class IPay88 {
    ...
    public static $requeryUrl               = 'https://sandbox.ipay88.co.id/epayment/enquiry.asp';
    public static $refererHost              = 'sandbox.ipay88.co.id' ;// Without scheme (http/https).
    public static $recurringUrlSubscription = 'https://sandbox.ipay88.co.id/recurringpayment/webservice/RecurringPayment.asmx/Subscription';
    public static $recurringUrlTermination  = 'https://sandbox.ipay88.co.id/recurringpayment/webservice/RecurringPayment.asmx/Termination';
