...
// Orders 
	...
	'nav_br_order_new' 					=> 'Create New Order',
	'br_orders' 					=> 'Orders', 
	...
	'br_order_total'		=> 'Total',
	'br_order_payment'		=> 'Payments',
	'br_order_balance'		=> 'Balance', 
	...
	'br_status_notify' 		=> 'Notify Customer',	
	'br_note_notify' 		=> 'Notify Customer',	
	...
	'br_print_packing_slip'		=> "Print Packing Slip",
	"method" 					=> "Method",
	"card_type" 				=> "Card Type",
	"exp_year"					=> "Expires",
	"cc_num"					=> "Card Number", 
...
// Products 
	...
	'br_local_files'	=> 'Batch Files',
	'br_s3_files'		=> 'S3 Files',
	'br_bucket_loading'	=> 'Loading S3 Buckets', 
	'br_file_loader'	=> 'Select a bucket in the left panel to review files in your S3 account.',
...
// Promotions 
	...
	'br_end_dt' 					=> 'End Date',
	'br_uses_per' 					=> 'Uses Per Code', 
	'br_min_subtotal' 				=> 'Minimum Subtotal', 
	'br_min_quantity' 				=> 'Minimum Quantity',
	'br_discount_type' 				=> 'Promotion Type',
	'br_cart'						=> 'Cart', 
	'br_fixed' 						=> 'Fixed',
	'br_free_shipping'				=> 'Free Shipping',
	'br_free_shipping_promotion'	=> 'Free Shipping',
	'br_max_discount'				=> 'Maximum Discount',
	'br_percent' 					=> 'Percent',
...
// Reports 
	...
	'br_total_results'	=> 'Total Results',
	'br_sales' 			=> 'Sales',
...
// Configuration
	...
	// Categories
		...
		'br_category_edit_product_search'	=> 'search here for products to add to the category…',
	...
	// Site 
		...
		'br_currency_instructions' => 'Changing the currency will not automatically adjust product pricing.', 
		'br_guest_checkout' => 'Guest Checkout',
		'br_register_group' => 'Default Member Group',
		'br_general_configuration' => 'General',
		'br_catalog' => 'Catalog',
		...
		'br_product_config' => "Products",
		'br_seo_config' => 'SEO',
		'br_low_stock' => 'Low Stock Threshold (Basic Stock)',
		'br_display_out_of_stock' 		=> 'Display Out of Stock', 
		'br_downloads_use_local' 		=> 'Allow Local Batch', 
		'br_downloads_use_s3' 			=> 'Allow S3 Delivery', 
		'br_downloads_local' 			=> 'Local Directory Path', 
		'br_downloads_s3_access_key' 	=> 'S3 Access Key', 
		'br_downloads_s3_secret_key' 	=> 'S3 Secret Key', 
		'br_download_source'			=> 'Source', 
		'br_downloads_s3_length'		=> 'S3 Link Expires',
		'br_downloads_s3_length_description' 	=> 'Enter the length of time in minutes that the link is valid for.',
	...
	// Front End 
		...
		// Customer 
			...
			"br_password_reset_email_sent"	=> "A reset password link has been sent to your email address.", 
		...
		// Checkout Messages
			...
			'br_billing_company'		=> 'Billing Company',
			'br_billing_phone' 			=> 'Billing Telephone', 
			'br_billing_address1' 		=> 'Billing Address 1', 
			'br_billing_address2' 		=> 'Billing Address 2', 
			'br_billing_city' 			=> 'Billing City', 
			'br_billing_state' 			=> 'Billing State', 
			'br_billing_zip' 			=> 'Billing Zip Code', 
			'br_billing_country'		=> 'Billing Country', 
			'br_shipping_fname' 		=> 'Shipping First Name', 
			'br_shipping_lname' 		=> 'Shipping Last Name', 
			'br_shipping_company'		=> 'Shipping Company', 
			'br_shipping_address1' 		=> 'Shipping Address 1', 
			'br_shipping_address2'		=> 'Shipping Address 2',
