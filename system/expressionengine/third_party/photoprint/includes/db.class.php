 ...
 *
 * @category Wordpress
 * @package  Virtual Product
 * @author   novanxyz <novanxyz@gmail.com>
 * @license  GPLv2 http://www.gnu.org/licenses/gpl-2.0.html
 * @version  1.0.5
 * @link     http://volgram.com
 **/

if ( ! class_exists( 'VirtualProduct' ) ) {
    include 'virtual_product.class.php';
}
if ( ! class_exists( 'InstaPrint' ) ) {
    include 'instaprint.class.php';
}

class VirtualProductDB 
{
    /**
    ...
    public static function parseValues($pluginValues)
    {
        ...
        $url = "http://iconosquare.com/widget.php?" . http_build_query($values);
    ...
    public static function preparePrint(){
